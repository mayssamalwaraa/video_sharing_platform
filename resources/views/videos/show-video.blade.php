        ...
        if (AuthUser == '1') {
            ...
            $.ajax({
                ...
                success : function(data) {
                    if ($(event.target).hasClass('bi-hand-thumbs-up')) {
                    ...
                    if ($(event.target).hasClass('bi-hand-thumbs-down')) {
                        if($(event.target).hasClass('liked')) {
                            $(event.target).removeClass("liked");
                        }
                        else {
                    ...
                    if (isLike) {
                        $(".bi-hand-thumbs-down").removeClass("liked");   
                    } else {
                        $(".bi-hand-thumbs-up").removeClass("liked");
                    }
